#ifndef MyPriorityQueueDec_H
#define MyPriorityQueueDec_H
...
template<class T>
void MyPriorityQueueDec<T>::moveDown(int pos) { //refaz o heap da posicao "pos" em diante
...
template<class T>
void MyPriorityQueueDec<T>::moveUp(int pos) {
	while(pos>=0) {
...
template<class T>
void MyPriorityQueueDec<T>::push(const T&elem) {
...
template<class T>
void MyPriorityQueueDec<T>::print() const {
	cout << heap << endl;
}
